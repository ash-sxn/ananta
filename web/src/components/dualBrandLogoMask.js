...
class DualBrandLogoMask {
  ...
  init() {
    ...
    console.log('=ƒÄ¡ Dual Brand Logo Mask initialized')
  }
  ...
  onTimelineComplete() {
    ...
    console.log('=ƒÄ¡ Dual brand timeline complete - ready for user interaction')
  }
  ...
  startExpandingReveal() {
    ...
    console.log('=ƒÄ¡ Starting expanding circle reveal')
  ...
  revealMainSite() {
    console.log('=ƒÄ¡ Revealing main site')
  ...
  cleanup() {
    ...
    console.log('=ƒÄ¡ Dual brand logo mask cleanup complete')
  }
  ...
  initMainSiteAnimations() {
    ...
    console.log('=ƒÄ¡ Main site animations initialized')
  }
  ...
  skip() {
    ...
    console.log('=ƒÄ¡ Skipping dual brand intro')
